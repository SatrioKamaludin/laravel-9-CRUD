...
Route::middleware(['admin'])->group(function(){  //menentukan function mana saja yang hanya dapat diakses oleh admin
...
Route::middleware(['auth'])->group(function(){  //menentukan function mana saja yang hanya dapat diakses oleh logged in user
